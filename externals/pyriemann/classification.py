...
# from sklearn.utils.extmath import softmax  # XXX only in most recent sklearn
from sklearn.linear_model import LogisticRegression
from sklearn.pipeline import make_pipeline
# from joblib import Parallel, delayed  # XXX no joblib in Azure
...
class MDM(BaseEstimator, ClassifierMixin, TransformerMixin):
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        if self.n_jobs == 1:
            ...
            #                              sample_weight=sample_weight[y == l])
            #     for l in self.classes_)
            raise RuntimeError('No joblib in Azure')
    ...
    def predict_proba(self, X):
        ...
        """
        return None  # XXX softmax(-self._predict_distances(X))
